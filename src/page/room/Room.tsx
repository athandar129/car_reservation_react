...
const sendDataToBackend = (data: { inputValues: ReservationData }) => {
  ...
  return (
        ...
        <div className="reservation-container">
          <h1 className={darkMode ? 'dark_title' : 'page_title'}>Meeting Rooms Schedule</h1>

          <div className="date">
            <div className='date__reservationBtn'>
              <Link to={`/${authRedux.role}-dashboard/room-reservation/reserve`} className={darkMode ? 'dark_reserve_btn' : 'link-style'}>
                Reserve Room
              </Link>
            </div>
          ...
          <div className="userData">
            <h1 className={darkMode ? 'dark_title' : 'page_title'}>Your Reservation for Today</h1>
