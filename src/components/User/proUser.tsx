...
import { Button, Switch, Dialog, DialogContent, colors } from "@mui/material";
...
function ProUser(): JSX.Element {
  ...
  const columns: TableColumn<DataRow>[] = [
    ...
    {
      name: "Status",
      cell: (row: DataRow) => <Switch checked={Boolean(row.status)} className={darkMode ? 'dark_switch' : ''} onChange={(event) => handleStatusChange(event,row)} />,
    },
    {
      name: "Actions",
      cell: (row: DataRow) => (
